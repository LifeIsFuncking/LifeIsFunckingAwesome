        ...
        <div class="container">
                ...
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#primary-menu">
                    ...
                    <!-- Entidad del nombre -->
                        <a href="#" class="navbar-brand logo" >
                            <!--<h3>LIFE IS FUCKING</h3>-->
                            <img src="images/bora.png">
                        
                        </a>
                <!-- fin Entidad del nombre -->
            ...
            <nav class="collapse navbar-collapse" id="primary-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#blog-page">SERVICIOS</a></li>
                    <li><a href="#feature-page">INFO</a></li>
        ...
        <div class="container">
           <!-- <div class="row v-center">
                <div class="col-xs-12 col-md-7 header-text">
                    ...
                    <p>Una barberia Especialista en cortes americanos y de todo tipo ,
                         ademas brindamos servicios en depilación , uñas  y otros.</p>
                         <p>Visitanos para tener el gusto de atenderte.</p>
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            ...
                                            <div class="caption-title" data-animation="animated fadeInUp">
                                                    ...
                                                    <div class="caption-desc" data-animation="animated fadeInUp">
                                                        <p>Somos LIFE IS FUCKING AWESOME  especialistas en el diseño Y cortes americanos, donde la inspiración y la imnovación se hace presente para que tu estilo sea el mejor..</p>
                                                        <p>Tenemos barberos profesionales ven y visitanos ya !</p>
        ...
        <div class="row">
                <div class="col-xs-12 col-sm-6 col-sm-offset-3 text-center">
                    <div class="page-title">
                        ...
                        <p>Somos LIFE IS FUCKING AWESOME  especialistas en el diseño Y  cortes americanos, donde la inspiración y la imnovación se hace presente para que tu estilo sea el mejor,
                                                        Tenemos barberos profesionales ven y visitanos ya !</p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 box">
                    <div class="single-blog">
                        <div class="blog-photo ">
                            <img src="https://okdiario.com/img/2018/04/04/cortar-el-pelo-masculino-655x368.jpg" alt="">
                        </div>
                        <div class="blog-content">
                            <h3><a href="#">SERVICIOS PARA HOMBRES</a></h3>
                            <ul class="blog-meta">
                                <li><span class="ti-user"></span> <a href="#">visitante</a></li>
                               <!--<li><span class="ti-calendar"></span> <a href="#">25/03/2019</a></li>-->
                            </ul>
                            <p>Cortes. </p>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-4 box">
                    <div class="single-blog">
                        <div class="blog-photo">
                            <img src="https://www.telemundo.com/sites/nbcutelemundo/files/images/article/cover/2015/12/22/mujer-de-cabello-rojizo-mostrando-rostro-de-perfil.jpg" alt="">
                        </div>
                        <div class="blog-content">
                            <h3><a href="#">SERVICIOS PARA MUJERES </a></h3>
                            <ul class="blog-meta">
                                <li><span class="ti-user"></span> <a href="#">visitante</a></li>
                                 <!--<li><span class="ti-calendar"></span> <a href="#">25/03/2019</a></li>-->
                            </ul>
                            <p>Arreglo de uñas, cabello, depilado con cera, depilación de cejas.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 box">
                    <div class="single-blog">
                        <div class="blog-photo">
                            <img src="https://storage.googleapis.com/mmc-elcaribe-bucket/uploads/2019/01/9d6183b0-spa.jpg" alt="">
                        </div>
                        <div class="blog-content">
                            ...
                            <p>Spa, masajes, limpieza facial. </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-sm-offset-3 text-center">
                    <div class="page-title">
                        <h2>SERVICIOS GENERALES</h2>
                        <p>Nuestro enfoque general son los cortes con maquina, pero tenemos otros servicios para complementar nuestros servicios </p>
                    </div>
                </div>
            </div>
            <div class="row">
...
?>
    ...
    <footer class="footer-area relative sky-bg" id="contact-page" style="background-color: #138fc2;;" >
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-sm-offset-3 text-center">
                        <div class="page-title">
                            <h2>CONTACTO</h2>
                            <p>Visitanos y  mejora tu aspecto fisico.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <address class="side-icon-boxes">
                            ...
                            <div class="side-icon-box">
                                ...
                                <p><strong>Telefonos: </strong>
                                    <a href="callto:8801812726495">322-677 68 16</a> <br />
                            ...
                            <div class="side-icon-box">
                                ...
                                <p><strong>correo: </strong>
                                    <a href="mailto:youremail@example.com">diego@gmail.com</a> <br />
                    ...
                    <div class="col-xs-12 col-md-8">
                        <form action="#" id="insert" method="POST" class="contact-form">
                            ...
                            <textarea name="mensaje"  name="mensaje" rows="5" class="form-control" placeholder="mensaje" required="required"></textarea>
                          
                            <input type="submit"  class="button" name="insert" value="enviar">
